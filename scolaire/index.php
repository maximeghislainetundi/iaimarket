...
$scolaire = "scolaire";
  ...
  $reqrecep1->execute(array($scolaire));
...
$reqLimit->execute(array($lastid, $scolaire));
$coun = $reqLimit->rowcount();
if($coun > 0){
  ?>

<center><a href="../scolaire/scolaire.php?limit=<?php echo($lastid);?>" class="btn-danger btn-lg">Suivant -->></a></center>
