...
$vestimentaire = "vestimentaire";
  ...
  $reqrecep1->execute(array($_SESSION['admin'], $vestimentaire));
...
<center><a href="../vestimentaire/vestimentaire.php?limit=<?php echo($lastid);?>" class="btn-danger btn-lg">Suivant -->></a></center>
