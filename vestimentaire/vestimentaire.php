...
$vestimentaire = "vestimentaire";
  ...
  $reqrecep1->execute(array($limit, $vestimentaire));
      ...
      <div class="row">
       ...
       <br><br><br>
        <div class="col-lg-6 col-xs-12 col-md-6 col-sm-6 main-section" id="contenu">
          <h2 align="center">Articles Vestimentaires</h2>
...
$reqLimit->execute(array($lastid, $vestimentaire));
...
$reqLimitpre->execute(array($vestimentaire));
